...
class SSPPI(nn.Module):
    ...
    def forward(self,  pro1 , pro2,device):
        ...
        x1,edge_index1,edge_index_high1, rwpe1,batch1, c_size1 = pro1.x, pro1.edge_index, pro1.edge_index_high, pro1.rwpe, pro1.batch, pro1.c_size
        x1 = self.pre_transform(x1)
        rwpe1 = self.pe_embedding(rwpe1)
        x1 = x1 + rwpe1

        x2, edge_index2, edge_index_high2, rwpe2,batch2, c_size2 = pro2.x, pro2.edge_index, pro2.edge_index_high, pro2.rwpe, pro2.batch, pro2.c_size
        ...
        hc,a_scores, b_scores = self.bilinear_attention(seq1_, seq2_)
        ...
        hc = self.dropout(hc)
        out = self.out(hc)
        return out, a_scores, b_scores, hc
