...
class SSPPI(nn.Module):
    def __init__(self,input_dim = 1280, hidden_dim = 64, output_dim = 1 ): #多分类的输出维度为7
        ...
        self.self_attn2 = SA_block( layer=1, hidden_dim=hidden_dim, num_heads=8, dropout=0, batch_first=True)
    ...
    def forward(self,  pro1 , pro2,device):
        ...
        #交叉注意
        seq1 = self.self_attn2(seq1, attn_mask=None, key_padding_mask=None)
        seq2 = self.self_attn2(seq2, attn_mask = None, key_padding_mask = None)
