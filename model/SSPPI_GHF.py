...
class GHF(nn.Module):
    def __init__(self,input_dim = 1280, hidden_dim = 64, output_dim = 1 ): #多分类的输出维度为7
        ...
        '''图注意力层'''
        self.GT1 = GATConv(hidden_dim, hidden_dim,1)
        self.GT2 = GATConv(hidden_dim, hidden_dim,1)
    ...
    def forward(self,  pro1 , pro2,device):
        ...
        '''GAT'''
        x1 = self.GT1(x1, edge_index1)
        x1 = self.GT2(x1, edge_index1)
        x2 = self.GT1(x2, edge_index2)
        x2 = self.GT2(x2, edge_index2)
